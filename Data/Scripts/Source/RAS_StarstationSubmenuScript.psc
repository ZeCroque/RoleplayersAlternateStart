Scriptname RAS_StarstationSubmenuScript extends Form
...
Event OnInit()
    ...
    Settlements = (RAS_StartingLocationActivator as RAS_StartingLocationActivatorScript).RAS_StarstationsLocationList.GetArray()
EndEvent

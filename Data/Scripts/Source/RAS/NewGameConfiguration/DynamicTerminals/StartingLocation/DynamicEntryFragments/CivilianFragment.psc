Scriptname RAS:NewGameConfiguration:DynamicTerminals:StartingLocation:DynamicEntryFragments:CivilianFragment extends MiscObject
...
Event RAS:NewGameConfiguration:DynamicTerminals:Base:DynamicEntriesTerminalScript.SelectedFragmentTriggered(RAS:NewGameConfiguration:DynamicTerminals:Base:DynamicEntriesTerminalScript akSender, var[] kArgs)
    If(kArgs[0] as Form == Self)
        ...
        If(!locationSpawnPointFinderQuestScript.MoveToLocation(locationSpawnPointFinderQuestScript.RandomSettlement.GetLocation(), !myShipVendorScript.NoShipSelected))

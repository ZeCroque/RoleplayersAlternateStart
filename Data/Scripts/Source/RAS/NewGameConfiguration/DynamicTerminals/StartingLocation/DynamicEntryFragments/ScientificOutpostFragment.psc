Scriptname RAS:NewGameConfiguration:DynamicTerminals:StartingLocation:DynamicEntryFragments:ScientificOutpostFragment extends MiscObject
...
Event RAS:NewGameConfiguration:DynamicTerminals:Base:DynamicEntriesTerminalScript.SelectedFragmentTriggered(RAS:NewGameConfiguration:DynamicTerminals:Base:DynamicEntriesTerminalScript akSender, var[] kArgs)
    If(kArgs[0] as Form == Self)
        ...
        If(!locationSpawnPointFinderQuestScript.MoveToLocation(locationSpawnPointFinderQuestScript.RandomScientificOutpost.GetLocation(), !myShipVendorScript.NoShipSelected))

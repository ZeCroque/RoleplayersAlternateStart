Scriptname RAS:NewGameConfiguration:DynamicTerminals:StartingLocation:DynamicEntryFragments:SettlementSubmenuFragment extends Form
...
Event OnInit()
    ...
    Settlements = (RAS_StartingLocationActivator as RAS:NewGameConfiguration:DynamicTerminals:StartingLocation:StartingLocationActivatorScript).RAS_SettlementsLocationList.GetArray()
EndEvent

Scriptname RAS:NewGameManagerQuest:FrontDoorToLodgeScript extends ReferenceAlias
...
Function SetWatchAnimationRequired(Bool isRequired)
    GetRef().BlockActivation(isRequired)
    If(isRequired)    
